        ...
        <div className="space-y-5">
          <div>
            ...
            <div className="mt-2.5">
              <input
                className="flex h-10 w-full rounded-md border border-gray-300 bg-white py-2 px-3 text-sm placeholder:text-grey-400 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-700 dark:text-gray-50 dark:focus:ring-gray-400 dark:focus:ring-offset-gray-900"
                type="text"
          ...
          <div>
            <label
              htmlFor="email"
              className="text-base font-mediumt text-white dark:text-gray-200"
            >
              {" "}
              Employee Email Id{" "}
            </label>
